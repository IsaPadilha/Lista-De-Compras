...
public class TelaListaCompras : TelaBase, ITelaOpcoes
{
    ...
    public TelaListaCompras(RepositorioListaCompras repositorioListaCompras, RepositorioProduto repositorioProduto) : base("Lista de Compras", repositorioListaCompras)
    {
